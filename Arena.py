...
class Bojovnik:
    ...
    def __str__(self):
        """Definice, která vrátí jméno bojovníka"""
    ...
    @property #Dekorátor, který "vylepšuje" metody. Dekorátor property mění metodu na vlastnost.
    def nazivu(self):
        """Definice určující, jestli je bojovník naživu
...
class Mag(Bojovnik):
    """Třída reprezentující mága do arény formou dědičnosti(vychází ze stejných vlastností jako bojovník)"""
